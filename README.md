...
0. Prism as MVVM Framework - https://prismlibrary.github.io/index.html
...
Used to accelerate the creation of bindable properties (two way data binding) in the view models
